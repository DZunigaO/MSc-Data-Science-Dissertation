...
def get_default_params_train(overrides={}):
    ...
    data
    '''
    params['species_set'] = 'all' # all, snt_birds, iucn_taxa
    params['hard_cap_seed'] = 626
    params['hard_cap_num_per_class'] = -1 # -1 for no hard capping
    params['aux_species_seed'] = 626
    params['num_aux_species'] = 0 # for snt_birds case, how many other species to add in
    params['h3_resolution'] = 1 # for definition of absence and proximity negatives
    params['proximity_k'] = 2  # for definition of proximity negatives
    '''
    data files
    '''
    ...
    params['negatives_source'] = 'absence'
    
    params['weighted'] = False
    params['learning'] = 'constant' # constant, epoch, 
...
def get_default_params_eval(overrides={}):
    ...
    params['experiment_name'] = 'demo'
    params['split'] = 'all' # all, val ,test
    params['val_frac'] = 0.60 #0.6
    params['split_seed'] = 626
